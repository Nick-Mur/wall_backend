...
class TestNormalizationStep(unittest.TestCase):
    def setUp(self):
        self.norm_step = NormalizationStep()

    def test_should_return_warning_for_too_many_spaces(self):
        """Return warning when text has 4 or more spaces in a row"""
        # given
        text = "Hello    world"  # 4

        # when
        result = self.norm_step.process(text)
    ...
    def test_should_return_warning_for_too_many_tabs(self):
    ...
    def test_should_return_warning_for_mixed_spaces_and_tabs(self):
    ...
    def test_should_accept_exactly_3_spaces(self):
    ...
    def test_should_accept_less_than_3_spaces(self):
    ...
    def test_should_return_warning_for_leading_spaces(self):
    ...
    def test_should_return_warning_for_trailing_spaces(self):
    ...
    def test_should_return_warning_for_leading_and_trailing_spaces(self):
    ...
    def test_should_return_warning_for_too_many_newlines(self):
    ...
    def test_should_accept_exactly_3_newlines(self):
    ...
    def test_should_accept_less_than_3_newlines(self):
    ...
    def test_should_return_warning_for_mixed_newlines_and_spaces(self):
    ...
    def test_should_return_none_for_text_with_single_space(self):
    ...
    def test_should_return_none_for_text_with_single_newline(self):
    ...
    def test_should_return_none_for_text_with_2_spaces(self):
    ...
    def test_should_return_none_for_text_with_2_newlines(self):
    ...
    def test_should_detect_spaces_before_newlines(self):
    ...
    def test_should_handle_text_with_only_spaces(self):
    ...
    def test_should_handle_text_with_only_newlines(self):
