...
Основная задача системы - безопасная публикация контента с автоматической модерацией, поддержкой анонимности и
масштабируемым поиском.

# Бизнес-контекст:

Микросервисная платформа “The Wall” - сервис публикации пользовательских сообщений с поиском, модерацией и управлением
